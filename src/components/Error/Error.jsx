...
import img from '../../../src/assets/undraw_compose_music_re_wpiw.svg'
    ...
    <div className="container z-10 flex items-center justify-between h-screen px-6 pt-32 mx-auto md:pt-0">
        <div className="container relative flex flex-col-reverse items-center justify-between px-6 mx-auto lg:flex-row">
            <div className="w-full mb-16 text-center md:mb-8 lg:text-left">
                ...
                <Link to={'/'}><button className="px-2 py-2  mt-16 text-lg font-normal text-black transition duration-200 ease-in bg-yellow-300 border-2 border-gray-700 w-36 hover:bg-yellow-400 focus:outline-none">
                    Go back home
                </button></Link>
            </div>
